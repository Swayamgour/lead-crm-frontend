...
function LeadTimeline() {
    ...
    if (isLoading) {
        return (
            <div className="min-h-[400px] flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-4">
                ...
                <p className="mt-4 text-gray-600 font-medium text-sm sm:text-base">Loading timeline...</p>
                <p className="text-xs sm:text-sm text-gray-400 mt-1">Please wait while we fetch your activities</p>
            </div>
        );
    }
